...
if (this.config.showGaugeShadow == true)
{
	...
	if (this.config.lowerWarningLimit > this.config.min && this.config.lowerWarningLimit > this.config.lowerActionLimit && this.config.lowerWarningLimit < this.config.max)
	{
	...
	if (this.config.upperWarningLimit > this.config.min && this.config.upperWarningLimit < this.config.upperActionLimit && this.config.upperWarningLimit < this.config.max)
	{
