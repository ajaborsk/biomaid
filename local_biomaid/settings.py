...
logging.getLogger(__name__).info("BiomAid demo config")
...
def global_status_message_func(params: dict, campagne_cls: 'dem.campagne'):
    ...
    if isinstance(params['user'], User):
        ...
        if len(qs) > 0:
            return _("La campagne de recensement pour le <b>{nom}</b> se termine le <b>{date}</b>.").format(
...
BIOM_AID_PORTALS = {
    'biom_aid': {
        ...
        'label': _("Portail BiomAid : Equipements"),
        'main-name': 'BiomAid',
        'home': 'dem:home',
        ...
        'external-menu': ('www-biomaid', 'www-afib', 'www-afib-2022'),
        'main-menu': (
            {
                'label': _("Accueil"),
                'url_name': 'dem:home',
            },
            {
                ...
                'help_text': _("Choisir un sous-menu pour saisir une nouvelle demande d'équipement."),
            ...
            },
            {
                ...
                'help_text': _("Toutes les demandes qui ne sont pas encore approuvées par le chef de pôle ou le directeur"),
            },
            {
            ...
            },
            {
                ...
                'help_text': _("Archives de toutes les demandes : Refusées ou acceptées et complètement traitées, etc."),
            },
        ),
    },
    'kos_bo': {
        ...
        'main-menu': (
            ...
            {
                'label': _("Nouvelle demande"),
                'help_text': _("Choisir un sous-menu pour saisir une nouvelle demande de travaux."),
                'permissions': DEM_DEMANDE_CREATION_ROLES,
                # 'show-only-if-allowed': True,
                'entries': [
                    {
...
BIOM_AID_CONFIGS = {
    ...
    'afib': {
        ...
        'persistent_help_stmpl': _(
            """<p style="text-align: center;"><b>BiomAid <span class="footer-version">V{{dem_version}} ({{dem_version_date}})
 </span></b> est un logiciel créé par des membres du Département Biomédical du CHU Amiens-Picardie : &copy; 2020-2022
 <span style="display:inline-block; white-space:nowrap;">
 <i class="fa fa-chevron-circle-right" style="padding-left: 1em;"></i> Brice Nord -
 ...
 </i> Romuald Kliglich - <a href="mailto:kliglich.romuald@chu-amiens.fr">kliglich.romuald@chu-amiens.fr</a></span>
 ...
 Alexandre Jaborska - <a href="mailto:jaborska.alexandre@chu-amiens.fr">jaborska.alexandre@chu-amiens.fr</a></span></p>"""
        ...
        'external-links': {
            ...
            'uniha': {
                'icon': None,
                'label': _("UniHA"),
                'help_text': _("Accès direct au portail internet d'UniHA"),
                'url': 'https://www.uniha.fr',
                'new_page': True,
            },
            'resah': {
                'icon': None,
                'label': _("ResaH"),
                'help_text': _("Accès direct au portail internet du ResaH"),
            ...
            'www-afib': {
                'icon': None,
                'label': _("AFIB"),
                'help_text': _("Accès direct au portail internet de l'AFIB"),
                'url': 'https://www.afib.asso.fr',
                'new_page': True,
            },
            'www-afib-2022': {
                'icon': None,
                # 'img':'local/Lille_2022_skyline.png',
                'label': _("AFIB Lille 2022"),
                'help_text': _("Accès direct au portail internet des journées AFIB 2022 de Lille"),
                'url': 'https://www.afib2022.fr',
                'new_page': True,
            },
            'www-biomaid': {
                'icon': None,
                'label': _("BiomAid"),
                'help_text': _("Accès direct au portail internet de BiomAid"),
                'url': 'https://www.biomaid.online',
                'new_page': True,
            },
        },
    },
