...
class Marques(models.Model):
    ma_nom = models.TextField(primary_key=True)
...
class Types(models.Model):
    tp_type = models.TextField(primary_key=True)
...
class BEq1996(models.Model):
    n_imma = models.CharField(max_length=64, primary_key=True)  # This field type is a guess.
    ...
    n_order = models.CharField(max_length=64, blank=True, null=True)  # This field type is a guess.
...
class EnCours(models.Model):
    ...
    int_cm = models.CharField(max_length=64, blank=True, null=True)  # This field type is a guess.
