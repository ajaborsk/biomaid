...
class Job(MyJob):
    help = _("Bascule les demandes validées et définitives vers le plan d'équipements (prévisionnel)")

    def execute(self):
        # executing empty sample job
        logger.info(_("Bascule des demandes vers le plan..."))

        # Pour exécuter une commande (de manage.py):
        from django.core import management

        management.call_command("add_previsionnels")
